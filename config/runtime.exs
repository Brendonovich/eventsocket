...
#
#     PHX_SERVER=true bin/eventsocket start
#
...
if config_env() == :prod do
  config :eventsocket, :twitch,
    client_id: Utils.env("TWITCH_CLIENT_ID"),
    client_secret: Utils.env("TWITCH_CLIENT_SECRET")

  config :eventsocket,
    callback_origin: Utils.env("CALLBACK_ORIGIN")

  app_name = Utils.env("FLY_APP_NAME")
